...
import LoginForm from './LoginForm'; // We will create this file next

// Add metadata for the login page
export const metadata: Metadata = {
  title: 'Login to Remityn',
  description: 'Log in to your Remityn account to securely send money internationally.',
};

// A simple loading fallback to show while the LoginForm client component is loading.
// This improves the user experience by showing an instant UI.
function LoadingFallback() {
  return (
    <div className="flex flex-col lg:flex-row min-h-screen lg:p-3 bg-background text-mainheadingWhite">
