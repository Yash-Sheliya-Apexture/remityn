...
// Define the content for each section separately
        ...
        <div>
          {sections.map((section) => (
            <section key={section.id} id={section.id}>
              ...
              <h2 className="lg:text-3xl md:text-2xl text-lg font-medium text-mainheading dark:text-primary my-5 leading-5">
                {section.title}
              </h2>
              {/* Changed to H2 */}
