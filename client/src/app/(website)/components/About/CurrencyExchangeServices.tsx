        ...
        <div className="flex flex-col lg:flex-row items-center gap-8">
          ...
          <div className="w-full lg:w-1/2 lg:order-1 order-2">
            ...
            <div className="relative sm:pb-28 pb-22 lg:pr-12">
              ...
              <div
                className="w-full absolute bottom-0 sm:right-30 right-7 sm:max-w-[360px] max-w-[260px] bg-primary-foreground p-4 sm:p-6 sm:rounded-3xl rounded-xl flex items-center shadow-2xl z-10 "
              >
