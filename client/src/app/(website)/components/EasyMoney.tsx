      ...
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
          <div className="space-y-6 text-center md:text-left w-full md:w-1/2 lg:order-2 order-1">
            ...
            <h1 className="text-5xl md:text-6xl font-black text-mainheading dark:text-white uppercase tracking-tight">
          ...
          <div className="w-full md:w-1/2 mt-8 md:mt-0 lg:order-1 order-2">
