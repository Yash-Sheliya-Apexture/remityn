...
const Easymoney: React.FC<EasymoneyProps> = () => {
  return (
    ...
    <section className="bg-white dark:bg-background lg:py-10 py-5 px-4 overflow-hidden">
      <div className="container mx-auto">
        ...
        >
          ...
          <motion.div
            className="lg:space-y-4 space-y-2 text-center md:text-left w-full md:w-1/2 lg:order-2 order-1"
          ...
          <motion.div
            className="w-full md:w-1/2 md:mt-8 mt-0 lg:order-1 order-2"
