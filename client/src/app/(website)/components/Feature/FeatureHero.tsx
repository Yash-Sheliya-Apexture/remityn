      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="w-full ">
            <div className="sm:bg-primary-foreground bg-none sm:p-8 p-0 sm:rounded-3xl rounded-xl w-full h-auto flex justify-center overflow-hidden">
              <Image
                ...
                quality={100}
                alt="Padlock symbolizing security"
                className="object-contain sm:rounded-3xl rounded-xl border border-primary w-full h-auto"
              />
            </div>
          </div>
        </div>
