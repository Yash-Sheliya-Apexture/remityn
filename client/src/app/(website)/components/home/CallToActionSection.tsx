...
//   return (
//     <section className="relative py-16 px-6 sm:px-12 md:px-20 lg:px-32 bg-background overflow-hidden">
//       <div className="absolute inset-0 bg-gradient-to-b from-[#66e8fa] to-[#ebebeb] z-0" />
//       <motion.div
...
//       >
//         <h2 className="text-4xl font-bold md:text-5xl text-mainheading max-w-2xl leading-tight">
//           Ready to Send or Exchange Currency in Seconds?
//         </h2>

//         <p className="text-lg md:text-xl text-subheading max-w-xl">
//           Sign up and transfer money across borders with real-time rates, full
//           transparency, and zero hassle.
//         </p>
...
//             <Button
//               variant="outline"
//               className="text-white hover:text-mainheading hover:bg-white font-semibold px-6 py-3 h-12.5 rounded-full transition-all ease-linear duration-75"
//             >
