...
const ReviewCards: React.FC = () => {
  ...
  // If still loading (initial fetch)
  if (initialLoading) {
    return (
      <section className="Reviews md:pt-14 pt-10 overflow-hidden relative pb-10 sm:pb-16">
        <div className="container mx-auto px-4">
  ...
  // If loading is finished, no error, but no reviews found
  if (!initialLoading && allReviews.length === 0 && !error) { // This check was already good
    return (
      <section className="Reviews md:pt-14 pt-10 overflow-hidden">
        <div className="container mx-auto px-4">
          {renderHeader()}
