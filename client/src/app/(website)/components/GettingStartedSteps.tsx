        ...
        >
          {methods.map((method, index) => (
            <motion.div
              ...
              variants={cardVariants} // Apply card animation variants
            >
              <div className="bg-white dark:bg-primarybox rounded-2xl border sm:p-6 p-4 lg:h-[350px] w-full ">
                <div className="flex flex-col lg:items-center lg:text-center text-left lg:space-y-4 space-y-2.5 h-full">
