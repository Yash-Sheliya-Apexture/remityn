          ...
          <div className="lg:max-w-xl lg:ml-auto w-full"> {/* Use max-w-xl and w-full */}
            <div className="bg-white dark:bg-background rounded-3xl shadow-lg md:p-8 p-4 border">
              ...
              <div className="mb-3">
                ...
                <div className="w-full border rounded-xl flex items-center justify-between">
                  <input
                    ...
                    readOnly
                    className="block w-full h-14 p-3 text-mainheading dark:text-white text-2xl font-black focus:outline-none" // Added appearance-none
                  />
                  {/* Fixed INR Display */}
                  <div className="flex items-center gap-2 w-24 pr-2"> {/* Added flex-shrink-0 */}
                    <Image src={inr} alt="INR Flag" width={24} height={24} />
                    <p className="text-mainheading dark:text-white  font-semibold">INR</p>
                  </div>
                </div>
              ...
              <div className="mt-2 text-sm text-gray-500 dark:text-gray-300">
                <p>You could save<span className="text-primary font-bold mx-1">2.2%</span>on the payment you make.</p>
                <p>
                  Should arrive by &nbsp;
                  <span className="text-primary font-medium">{arrivalDate || 'calculating...'}</span>
                </p>
              </div>
