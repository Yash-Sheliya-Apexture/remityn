...
const HeroSection: React.FC = () => {
  ...
  // --- JSX Render ---
  return (
    // Note: TooltipProvider is usually best placed higher up in your app's layout (e.g., _app.tsx or layout.tsx)
    // <TooltipProvider> // <--- Add if not already present higher up
