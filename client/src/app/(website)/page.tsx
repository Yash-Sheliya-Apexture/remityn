...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Fast & Secure International Money Transfers by Remityn',
    description: 'Join Remityn for the best rates on international money transfers. Send money to family and friends worldwide with ease.', // Added full description here for better social sharing
    images: [
      {
