        ...
        {!isLoading &&
          ...
          showToggleButton && ( // Conditionally render button if needed
            <div className="flex justify-center mt-4">
              <button
                onClick={handleToggleViewMoreLess}
                className="bg-primarybox text-primary hover:bg-secondarybox px-4 py-2 rounded-full text-sm font-semibold transition-all duration-75 ease-linear focus:outline-none focus:ring-0 cursor-pointer" // Adjusted hover for dark mode
              >
                {buttonText}
              </button>
            </div>
