...
const TransactionActions: React.FC<TransactionActionsProps> = ({
    ...
    return (
        <div className="flex justify-between items-center gap-4 sm:w-auto w-full">
            ...
            <button
                className="inline-flex items-center justify-center gap-3 bg-primary text-neutral-900 hover:bg-primaryhover h-12.5 md:w-36 w-12.5 font-medium rounded-full transition-all duration-75 ease-linear cursor-pointer shrink-0" // Added shrink-0
