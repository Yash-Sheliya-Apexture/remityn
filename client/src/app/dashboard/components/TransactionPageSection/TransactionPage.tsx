        ...
        <div className="">
          <div className="container mx-auto">
            ...
            <div className="space-y-4">
              {inProcessTransactions.length > 0 && (
                <div>
                  <h2 className="font-medium text-gray mb-3 relative after:content-[''] after:block after:w-full after:h-[1px] after:rounded-full after:bg-gray/20 after:mt-1">
                    In progress
                  </h2>
                  <div className="space-y-2">
                    {inProcessTransactions.map((transaction) => {
                        ...
                        <div key={transaction._id}>
                          ...
                          >
                            ...
                            <div className="hover:bg-lightgray p-2 sm:p-4 rounded-2xl transition-colors duration-500 ease-in-out cursor-pointer">
                              ...
                              <div className="flex items-center gap-4">
                                <div className="p-3 bg-lightborder rounded-full flex items-center justify-center ">
                                  {transaction.type === "Add Money" ? (
                                    <LuPlus size={24} className="text-main" />
                                  ) : (
                                    <GoArrowUp
                ...
                <div>
                  <div className="space-y-4">
                    {Object.entries(groupedProcessedTransactions).map(
                      ([date, transactionsForDate]) => (
                        <div key={date}>
                          <h3 className="font-medium text-gray mb-3 relative after:content-[''] after:block after:w-full after:h-[1px] after:rounded-full after:bg-gray/20 after:mt-1">
                            {date}
                          </h3>
                          <div className="space-y-2">
                            {transactionsForDate.map((transaction) => {
              ...
              {inProcessTransactions.length === 0 &&
                ...
                !error && (
                  <div className="py-20 flex flex-col items-center">
                    <Image src={"/assets/images/not-found.jpg"} alt="no-found" width={150} height={150}/>
                    <p className="text-center text-lg text-gray-500 ">You don't have any transactions.</p>
                  </div>
                )}
            </div>
          </div>
