...
//       try {
//         const response = await axios.get<{ currency: { code: string } }>(
//           `/accounts/${balanceId}`,
//           {
//             headers: { Authorization: `Bearer ${token}` },
//           }
...
//     if (!paymentSummary) {
//       // Check for null/undefined paymentSummary
//       // This could happen if calculation failed or hasn't completed yet after input.
//       alert(
//         "Payment details are not available. Please ensure a valid amount is entered and details have loaded."
//       );
//       return;
//     }
//     if (isDetailsLoading) {
...
//         <Skeleton className="md:h-12 h-8 md:w-64 w-40 rounded-lg mx-auto" />
...
//     : isDetailsLoading
//     ? "..."
//     : "0.00"; // Use isDetailsLoading for summary section loading
//   const calculatedWiseFee =
...
//   const totalFees =
//     paymentSummary &&
//     typeof paymentSummary.wiseFee === "number" &&
//     typeof paymentSummary.bankTransferFee === "number"
//       ? (paymentSummary.wiseFee + paymentSummary.bankTransferFee).toFixed(2)
//       : isDetailsLoading
//       ? "..."
//       : "0.00";
...
//       <h2 className="lg:text-3xl md:text-2xl text-xl lg:text-center text-left capitalize font-semibold text-mainheadingWhite pb-4">
//         Add Money to {balanceCurrency.code} Balance
//       </h2>
...
//         <label
//           htmlFor="amount"
//           className="block lg:text-base text-sm font-medium text-mainheadingWhite"
//         >
//           Amount to add
//         </label>
...
//             name="amount"
//             id="amount"
//             className="block w-full text-xl rounded-xl ps-2 font-bold lg:h-18 h-16 py-3 pl-5 pr-28 focus:outline-0 transition-all duration-75 ease-in-out placeholder:text-gray-400 border border-gray-600 hover:border-gray-500 focus:border-gray-500 text-mainheadingWhite bg-primarybox/50 no-spinner"
//             placeholder="0.00"
...
//             <div
//               id="amount-currency"
//               className="px-2 gap-2 flex items-center"
//             >
//               <span className="inline-block rounded-full overflow-hidden">
//                 <Image
...
//                 />
//               </span>
//               <span className="mr-2 text-mainheadingWhite font-bold md:text-xl text-lg">
//                 {balanceCurrency.code}
//               </span>
//             </div>
//           </div>
...
//         <div className="mt-4">
//           <label className="block text-sm lg:text-base font-medium text-mainheadingWhite">
//             Paying with
//           </label>

//           <div className="border rounded-xl ps-5 lg:py-4 py-3 flex items-center gap-4 mt-1">
//             <div className="p-2.5 bg-green-500/20 rounded-full inline-block">
//               <AiFillBank className="md:size-7 size-6 text-green-400" />
//             </div>
//             <span className="text-mainheadingWhite   font-semibold capitalize md:text-lg text-base">
//               Bank transfer
//             </span>
//           </div>
//         </div>
...
//         {/* currency calculation */}
//         <div className="mt-4 border rounded-xl p-4 ">
//           <div className="py-2 flex justify-between text-sm text-subheadingWhite">
//             <dt className="text-subheadingWhite">Currency to pay in</dt>
//             <dd className="ml-6 text-mainheadingWhite font-bold">
//               {/* payInCurrencyCode is derived state */}
//               {payInCurrencyCode}
//             </dd>
//           </div>
//           <div className="py-2 flex justify-between text-sm text-subheadingWhite">
//             <dt className="text-subheadingWhite">Bank transfer fee</dt>
//             <dd className="ml-6 text-mainheadingWhite  font-medium">
//               {isDetailsLoading ? (
...
//           </div>
//           <div className="py-2 flex justify-between text-sm text-subheadingWhite">
//             <dt className="text-subheadingWhite">Our fee</dt>
//             <dd className="ml-6 text-mainheadingWhite font-medium">
//               {isDetailsLoading ? (
//                 <Skeleton className="h-4 w-16 inline-block" />
//               ) : (
...
//             </dd>
//           </div>
//           <div className="py-2 flex justify-between text-sm text-mainheadingWhite">
//             <dt className="text-subheadingWhite font-medium">
//               Total included fees
//             </dt>
//             <dd className="ml-6 text-mainheadingWhite font-bold">
//               {isDetailsLoading ? (
...
//             <dt className="text-mainheadingWhite font-bold capitalize">
//               Total you'll pay
//             </dt>
//             <dd className="ml-6 text-mainheadingWhite font-bold">
//               {isDetailsLoading ? (
...
//           <Skeleton className="h-16 lg:h-18 w-full rounded-xl" /> {/* Input field */}
//         </div>

//         {/* Paying with section Skeleton */}
//         <div className="space-y-1.5 mt-4">
//           <Skeleton className="h-5 w-20 rounded" /> {/* Label */}
//           <Skeleton className="h-14 lg:h-18.5 w-full rounded-xl" /> {/* Bank transfer box */}
//         </div>

//         {/* Currency calculation section Skeleton */}
//         <div className="border rounded-xl p-4 mt-4">
//           {/* Row 1: Currency to pay in */}
//           <div className="flex justify-between py-2 items-center">
//             <Skeleton className="h-5 w-[45%] rounded" /> {/* Label */}
//             <Skeleton className="h-5 w-[15%] rounded" /> {/* Value */}
//           </div>
//           {/* Row 2: Bank transfer fee */}
//           <div className="flex justify-between py-2 items-center">
//             <Skeleton className="h-5 w-[40%] rounded" /> {/* Label */}
//             <Skeleton className="h-5 w-[25%] rounded" /> {/* Value */}
//           </div>
//           {/* Row 3: Our fee */}
//           <div className="flex justify-between py-2 items-center">
//             <Skeleton className="h-5 w-[20%] rounded" /> {/* Label */}
...
//           {/* Row 4: Total included fees */}
//           <div className="flex justify-between py-2 items-center">
//             <Skeleton className="h-5 w-[50%] rounded" /> {/* Label */}
//             <Skeleton className="h-5 w-[25%] rounded" /> {/* Value */}
//           </div>
...
//           {/* Row 5: Total You'll Pay */}
//           <div className="flex justify-between py-3.5 items-center">
//             <Skeleton className="h-5 w-[40%] rounded" /> {/* Label (bolder) */}
//             <Skeleton className="h-5 w-[25%] rounded" /> {/* Value (bolder) */}
//           </div>
//         </div>

//         {/* Continue button Skeleton */}
//         <Skeleton className="h-12.5 w-full mt-4 rounded-full" />
//       </div>
//     );
//   }
...
// const MAX_AMOUNT_LIMIT = 50000; // Define the maximum amount limit
...
//   const [maxAmountError, setMaxAmountError] = useState<string | null>(null); // For max amount validation error
...
//       setIsLoading(true);
//       setError(null);
//       setMaxAmountError(null); // Clear any previous errors
//       try {
//         const response = await axios.get<{ currency: { code: string } }>(
//           `/accounts/${balanceId}`,
//           {
...
//       amount: number,
//       balCurrencyCode: string,
//       payInCurrCode: string,
//       authToken: string
//     ) => {
//       // Clear previous API errors when starting a new calculation
//       setError(null);
//       try {
//         const response = await axios.post<PaymentSummary>(
//           "/payments/add-money/calculate-summary",
//           {
//             balanceCurrencyCode: balCurrencyCode,
//             payInCurrencyCode: payInCurrCode,
//             amountToAdd: amount,
//           },
//           {
//             headers: { Authorization: `Bearer ${authToken}` },
...
//       typeof amountToAdd === "number" &&
//       amountToAdd > 0 &&
//       !maxAmountError && // Don't calculate if there's a max amount error
//       balanceCurrency?.code &&
//       token
//     ) {
//       setIsDetailsLoading(true);
//       setError(null); // Clear previous calculation API errors
...
//       setPaymentSummary(null);
//       setIsDetailsLoading(false);
//       // Don't clear general 'error' here, as it might be an initial load error or other API error.
//       // maxAmountError is handled, and calculation API errors are cleared before new calc attempt.
//     }
...
//     token,
//     fetchPaymentSummary,
//     maxAmountError, // Added dependency
//   ]);
...
//     if (value === "") {
//       setAmountToAdd("");
//       setMaxAmountError(null); // Clear max amount error if input is empty
//       // useEffect will clear paymentSummary
//     } else {
//       if (/^\d*\.?\d{0,2}$/.test(value)) {
//         const numberValueParsed = parseFloat(value);

//         if (!isNaN(numberValueParsed) && numberValueParsed >= 0) {
//           setAmountToAdd(numberValueParsed); // Set amount to reflect in input

//           if (numberValueParsed > MAX_AMOUNT_LIMIT) {
//             setMaxAmountError(
//               `Amount cannot exceed ${MAX_AMOUNT_LIMIT.toLocaleString()} ${
//                 balanceCurrency?.code || ""
//               }.`
//             );
//             setPaymentSummary(null); // Clear summary if limit exceeded
//             setIsDetailsLoading(false); // Stop details loading
//           } else {
//             setMaxAmountError(null); // Clear error if within limit
//             // API call will be triggered by useEffect if amount > 0 and no maxAmountError
//           }
//         }
//       }
//     }
...
//   const handleContinue = async () => {
//     if (maxAmountError) {
//       // This should ideally be prevented by button disable, but safeguard
//       alert(maxAmountError);
//       return;
//     }
//     if (
//       typeof amountToAdd !== "number" ||
...
//     if (!paymentSummary) {
//       alert(
//         "Payment details are not available. Ensure a valid amount is entered and details have loaded."
//       );
//       return;
//     }
//     if (isDetailsLoading) {
...
//     setMaxAmountError(null); // Clear validation errors
...
//   if (isLoading && !balanceCurrency && !error) {
//     // Show skeleton only if truly initial loading and no fatal error
//     return (
//       <div className="max-w-lg mx-auto">
//         {/* Title Skeleton */}
//         <Skeleton className="md:h-13 h-11 w-2/3 mx-auto mb-4 rounded-md" />
...
//   // Display fatal error for balance currency loading AFTER skeleton check
//   if (error && !balanceCurrency && !isLoading) {
//     return (
//       <div className="max-w-lg mx-auto bg-red-900/25 border border-red-500 rounded-lg p-4 flex items-center gap-3 mt-5">
//         <div className="flex-shrink-0 sm:size-12 size-10 rounded-full flex items-center justify-center bg-red-600/20">
//           <FiAlertTriangle className="text-red-500 size-5 sm:size-6 flex-shrink-0" />
//         </div>
//         <p className="text-red-300/90">
...
//   if (!balanceCurrency) {
//     // This case should be covered by skeleton or error, but as a fallback:
//     return (
//       <div className="max-w-xl mx-auto p-4 lg:p-8 text-center text-mainheadingWhite">
...
//   const calculatedAmountToPay = paymentSummary
//     ? parseFloat(paymentSummary.amountToPay.toString()).toFixed(2)
//     : isDetailsLoading && !maxAmountError // Show "..." only if loading and no maxAmountError
//     ? "..."
//     : "0.00";
//   const calculatedWiseFee =
//     paymentSummary?.wiseFee !== undefined
//       ? parseFloat(paymentSummary.wiseFee.toString()).toFixed(2)
//       : isDetailsLoading && !maxAmountError
//       ? "..."
//       : "0.00";
//   const calculatedBankTransferFee =
//     paymentSummary?.bankTransferFee !== undefined
...
//   const displayError = maxAmountError || (error ? error : null); // Prioritize maxAmountError

//   const isButtonDisabled =
//     isLoading || // Main page/initiation loading (after click) OR initial balance loading
//     isDetailsLoading || // Calculation is in progress
//     typeof amountToAdd !== "number" ||
//     amountToAdd <= 0 ||
//     !!maxAmountError || // If there's a max amount error
//     !paymentSummary; // Payment summary has not been successfully calculated
...
//         <div className="relative mt-1 rounded-md">
//           <input
//             type="text" // Use text for better control over formatting and validation display
//             inputMode="decimal" // Hint for mobile keyboards
//             name="amount"
//             id="amount"
//             className={`block w-full text-xl rounded-xl ps-2 font-bold lg:h-18 h-16 py-3 border bg-primarybox/50 pl-5 pr-28 focus:outline-0 transition-all duration-75 ease-in-out placeholder:text-gray-400 text-mainheadingWhite no-spinner ${
//               maxAmountError
//                 ? "border-red-500 hover:border-red-600 focus:border-red-600 bg-red-900/20 text-red-500" // Red border for error
//                 : "border-gray-600 hover:border-gray-500 focus:border-gray-500"
//             }`}
//             placeholder="0.00"
//             value={String(amountToAdd)} // amountToAdd can be "" or number
//             onChange={handleAmountChange}
//             required
//             aria-describedby="amount-currency"
//             aria-invalid={!!maxAmountError} // Accessibility: mark as invalid if error
//           />

//           <div className="absolute inset-y-0 right-0 flex items-center pointer-events-none">
//             <div id="amount-currency" className="px-2 gap-2 flex items-center">
//               <span className="inline-block rounded-full overflow-hidden">
//                 <Image
//                   src={`/assets/icon/${balanceCurrency.code.toLowerCase()}.svg`}
//                   alt={`${balanceCurrency.code} Flag`}
...
//             <dt className="text-subheadingWhite">Bank transfer fee</dt>
//             <dd className="ml-6 text-mainheadingWhite font-medium">
//               {isDetailsLoading && !maxAmountError && !paymentSummary ? ( // Show skeleton only if loading valid data
//                 <Skeleton className="h-3 w-16 inline-block" />
//               ) : (
//                 `${calculatedBankTransferFee} ${payInCurrencyCode}`
//               )}
...
//             <dt className="text-subheadingWhite">Our fee</dt>
//             <dd className="ml-6 text-mainheadingWhite font-medium">
//               {isDetailsLoading && !maxAmountError && !paymentSummary ? (
//                 <Skeleton className="h-3 w-16 inline-block" />
//               ) : (
//                 `${calculatedWiseFee} ${payInCurrencyCode}`
//               )}
...
//           >
//             {isLoading && !isDetailsLoading ? ( // Show spinner for final submission loading
//               <>
//                 <svg
//                   className="h-5 w-5 text-neutral-900 animate-spin mr-2"
//                   viewBox="0 0 24 24"
...
const AddMoneyPage = () => {
  ...
  const [isLoading, setIsLoading] = useState(true); // For initial load and final submission
  const [isDetailsLoading, setIsDetailsLoading] = useState(false); // For payment summary calculation
  const [error, setError] = useState<string | null>(null); // For API errors
  const [maxAmountError, setMaxAmountError] = useState<string | null>(null); // For max amount validation error
  ...
  const fetchPaymentSummary = useCallback(
    async (
      ...
      setError(null); // Clear previous API errors for calculation
      try {
        const response = await axios.post<PaymentSummary>(
          "/payments/add-money/calculate-summary",
          {
        ...
        setError(errorMessage); // Set API error for calculation
        console.error("Error calculating payment summary:", err);
        setPaymentSummary(null);
      } finally {
        setIsDetailsLoading(false);
  ...
  useEffect(() => {
    ...
    if (
      typeof amountToAdd === "number" &&
      amountToAdd > 0 &&
      !maxAmountError && // Critical: Don't calculate if there's a max amount error
      balanceCurrency?.code &&
      token
    ) {
      setIsDetailsLoading(true);
      ...
      setPaymentSummary(null); // Clear summary if conditions not met (e.g., amount is 0, or maxAmountError exists)
      setIsDetailsLoading(false);
    }
    ...
    token,
    fetchPaymentSummary,
    maxAmountError, // Ensure effect re-runs if maxAmountError changes
  ]);
  ...
  const handleAmountChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (value === "") {
      setAmountToAdd("");
      setMaxAmountError(null);
      // useEffect will handle clearing paymentSummary and isDetailsLoading
    } else {
      // Regex allows numbers, optional decimal, up to 2 digits after decimal.
      if (/^\d*\.?\d{0,2}$/.test(value)) {
        const numberValueAttempt = parseFloat(value);

        if (!isNaN(numberValueAttempt) && numberValueAttempt >= 0) {
          if (numberValueAttempt > MAX_AMOUNT_LIMIT) {
            setAmountToAdd(MAX_AMOUNT_LIMIT); // Cap the value in state
            setMaxAmountError(
              `Amount cannot exceed ${MAX_AMOUNT_LIMIT.toLocaleString()} ${
                balanceCurrency?.code || "" // Use loaded currency code in error
              }.`
            );
            setPaymentSummary(null); // Clear summary as the input is invalid for calculation beyond limit
            setIsDetailsLoading(false); // Stop loading details
          } else {
            setAmountToAdd(numberValueAttempt); // Set the valid, within-limit amount
            setMaxAmountError(null); // Clear error if amount is valid
          }
        }
        // If parse is NaN (e.g. just "."), state is not updated here.
        // The input field shows what user typed. Effect won't run for NaN.
      }
      // If regex fails (e.g. "abc"), state is not updated. Input field shows what user typed.
    }
  };

  const handleContinue = async () => {
    if (maxAmountError) {
      // Should be caught by disabled button, but good safeguard
      alert(maxAmountError);
      return;
    }
    if (
    ...
    setIsLoading(true); // Use main loading for submission
    setError(null);
    // maxAmountError should be null here due to button disable logic
    ...
    return (
      <div className="max-w-lg mx-auto">
        ...
        <div className="border rounded-xl p-4 mt-6">
          <div className="flex justify-between py-2 items-center">
            <Skeleton className="h-4.5 w-[45%] rounded" />
            <Skeleton className="h-4.5 w-[15%] rounded" />
          </div>
          <div className="flex justify-between py-2 items-center">
            <Skeleton className="h-4.5 w-[40%] rounded" />
            <Skeleton className="h-4.5 w-[25%] rounded" />
          </div>
          <div className="flex justify-between py-2 items-center">
          ...
          <div className="flex justify-between py-2 items-center">
            <Skeleton className="h-4.5 w-[50%] rounded" />
            <Skeleton className="h-4.5 w-[25%] rounded" />
          </div>
  ...
  // Fatal error if initial balance currency fetch failed
  if (error && !balanceCurrency && !isLoading) {
    return (
      <div className="max-w-lg mx-auto bg-red-900/25 border border-red-500 rounded-lg p-4 flex items-center gap-3 mt-5">
        <div className="flex-shrink-0 sm:size-12 size-10 rounded-full flex items-center justify-center bg-red-600/20">
  ...
  const isButtonDisabled =
    isLoading || // Main submission loading OR initial balance loading
    isDetailsLoading ||
    typeof amountToAdd !== "number" ||
    amountToAdd <= 0 ||
    !!maxAmountError || // If there's a max amount error (input validation)
    !paymentSummary;
  ...
  return (
    <div className="max-w-lg mx-auto">
      ...
      {/* Display general API errors here (not maxAmountError) */}
      {error && (
        <div className="bg-red-900/25 border border-red-500 rounded-xl p-4 flex items-center gap-4 mb-3 py-5">
          <div className="flex-shrink-0 sm:size-12 size-10 rounded-full flex items-center justify-center bg-red-600/20">
            <FiAlertTriangle
      ...
      <div>
        ...
        <div className="relative mt-1">
          {" "}
          {/* Removed rounded-md from here, applying to input */}
          <input
            type="text" // Using text for finer control with regex and capping
            ...
            placeholder="0.00"
            value={String(amountToAdd)} // Controlled component
            onChange={handleAmountChange}
            required
            aria-invalid={!!maxAmountError}
            aria-describedby={`amount-currency ${
              maxAmountError ? "amount-input-error" : ""
            }`.trim()}
          />
          <div className="absolute inset-y-0 right-0 flex items-center pointer-events-none">
            <div id="amount-currency" className="px-2 gap-2 flex items-center">
        ...
        {/* Display maxAmountError directly below the input field */}
        {maxAmountError && (
          <p id="amount-input-error" className="mt-1 text-sm text-red-500">
            {maxAmountError}
          </p>
        )}
        ...
        <div className="mt-4 border rounded-xl p-4">
          ...
          <div className="py-3.5 flex justify-between text-sm border-t dark:border-neutral-700">
            <dt className="text-mainheadingWhite font-bold capitalize">
              Total you'll pay
            </dt>
            <dd className="ml-6 text-mainheadingWhite font-bold">
        ...
        <div className="mt-4">
          <button
            onClick={handleContinue}
            className={`flex items-center justify-center w-full bg-primary text-neutral-900 font-medium hover:bg-primaryhover gap-2 py-3 px-8 h-12.5 rounded-full transition-all duration-75 ease-linear ${
              isButtonDisabled
                ? "cursor-not-allowed opacity-50"
                : "cursor-pointer"
            }`}
            disabled={isButtonDisabled}
          >
            {isLoading && !isDetailsLoading ? ( // Spinner for final submission
              <>
                <svg
