...
//       {/* Use motion.section for the main container */}
//       <motion.section
//         className="Error-Page flex items-center justify-center min-h-screen py-10"
//         // Apply container variants for overall page load animation (optional, can be on inner div too)
//         initial="hidden"
//         animate="visible"
//         variants={containerVariants} // You could apply stagger here too
...
//             <motion.h1
//               variants={itemVariants}
//               className="text-4xl font-SatoshiVariable sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight text-mainheadingWhite"
//             >
//               Oops!{" "}
...
//             <motion.p
//               variants={itemVariants}
//               className="text-lg md:text-xl text-subheadingWhite max-w-3xl px-2"
//             >
//               Looks like this page missed the currency route! But don’t worry —
//               your funds and support are just a click away.
//             </motion.p>
...
//                 className="bg-primary hover:bg-primaryhover gap-2 capitalize text- w-fit cursor-pointer font-medium text-sm lg:text-base py-3 px-10 h-12.5 rounded-full transition-all duration-75 ease-linear flex items-center justify-center"
//               >
//                 {buttonText}{" "}
...
//               height={600}
//               alt="404 Error Illustration Light"
//               className="max-w-full object-contain sm:aspect-square max-h-[500px]"
//               priority // Good practice for LCP images
//             />
//           </motion.div>
//         </motion.div>
