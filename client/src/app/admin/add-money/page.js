...
//                                                 <motion.button
//                                                     onClick={() => handleEditPayment(payment)}
//                                                     className="bg-white gap-2 border border-error cursor-pointer rounded-md px-4 py-2 font-medium text-error focus:outline-none flex items-center"
//                                                 >
//                                                     <Edit size={18}  />
//                                                     Edit
//                                                 </motion.button>
...
//                                         className="p-2 rounded cursor-pointer focus:outline-none"
//                                         aria-label="Copy Payment ID"
//                                     >
//                                         <Copy className="size-4 text-gray-500" />
//                                     </button>
//                                 </div>
//                                 {isPaymentIdCopied && <p className="text-sm -mt-3 text-green-500">Payment ID copied!</p>}
...
//                                     </button>
//                                 </div>
//                                 {isReferenceCodeCopied && <p className="text-sm -mt-3 text-green-500">Reference Code copied!</p>}
...
//                                 <button
//                                     onClick={() => setIsEditModalOpen(false)}
//                                     className="px-4 w-full py-3 cursor-pointer bg-gray-300 text-main text-lg font-medium rounded-md focus:outline-none"
//                                 >
//                                     Cancel
//                                 </button>
//                                 <button
//                                     onClick={handleSaveEdit}
//                                     disabled={editLoading}
//                                     className={`px-4 py-3 w-full cursor-pointer bg-primary font-medium text-lg text-secondary rounded-md hover:bg-primary-hover focus:outline-none ${editLoading ? 'opacity-50 cursor-wait' : ''}`}
//                                 >
//                                     {editLoading ? 'Saving...' : 'Save'}
//                                 </button>
//                             </div>
...
//                                         <button
//                                             onClick={() => toggleSort('_id')}
//                                             className="flex items-center gap-1 hover:text-primary uppercase focus:outline-none"
//                                         >
//                                             Payment ID
//                                             {sortField === '_id' && (
//                                                 <ArrowDownUp size={18} className={sortDirection === 'desc' ? 'rotate-180' : ''} />
...
//                                 {filteredPayments.length === 0 ? (
//                                     <tr>
//                                         <td colSpan="7" className="px-6 py-10  font-medium text-lg text-center text-gray capitalize">
//                                             No payments found matching your filters.
//                                         </td>
//                                     </tr>
//                                 ) : (
...
//                             <div className="flex justify-between items-center">
//                                 <h3 className="text-xl font-medium text-gray-900">Filter Payments</h3>
//                                 <button
//                                     onClick={() => setShowFilterModal(false)}
...
//                             animate={{ opacity: 1, y: 0 }}
//                             exit={{ opacity: 0, y: 10 }}
//                             className="absolute mt-2 w-full capitalize bg-white rounded-md shadow-lg z-0 border border-gray-300 overflow-hidden"
//                         >
//                             {options.map((option) => (
//                                 <motion.li
//                                     key={option}
...
//                                 value={currencyFilter === 'all' ? null : currencyFilter}
//                                 onChange={setCurrencyFilter}
//                                 options={currencyOptions.filter(opt => opt !== 'all')} // Filter out 'all' for sidebar dropdown
//                             />
...
//                                 value={statusFilter === 'all' ? null : statusFilter}
//                                 onChange={setStatusFilter}
//                                 options={statusOptions.filter(opt => opt !== 'all')} // Filter out 'all' for sidebar dropdown
//                             />
...
//     useEffect(() => {
//         const handleClickOutside = (event) => {
//             if (isOpen && dropdownRef.current && !dropdownRef.current.contains(event.target) && inputFieldRef.current && !inputFieldRef.current.contains(event.target)) {
//                 setIsOpen(false);
//             }
//         };
...
//                                 type="button"
//                                 onClick={() => setShowFilterModal(false)}
//                                 className="inline-flex bg-primary w-full justify-center px-6 py-3 cursor-pointer text-main font-medium border border-transparent rounded-md shadow-sm hover:bg-primary-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
//                             >
//                                 Apply Filters
//                             </button>
//                         </div>
//                         {/* Applied Filters Display inside Sidebar */}
//                         <div className="px-6 py-4">
//                             <h4 className="font-semibold text-main text-xl mb-3">Applied Filters</h4>
//                             <div className="space-y-2 py-5">
//                                 {searchTerm && (
//                                     <div className="bg-primary text-main rounded-md px-4 py-2.5 text-sm flex items-center justify-between">
//                                         <span>User Search: {searchTerm}</span>
//                                         <button onClick={() => setSearchTerm('')} className="ml-2">
//                                             <X size={20} />
//                                         </button>
...
//     const handleStatusDropdownChange = (status) => {
//         setStatusFilter(status); // Directly update statusFilter for dropdown in filter modal
//         setEditFormData({ ...editFormData, status: status }); // Update edit form status
//     };
...
//             const response = await axios.put(`/admin/payments/${selectedPaymentForEdit._id}`, payload, {
//                 headers: { Authorization: `Bearer ${token}` },
//             });
...
//                 setIsEditModalOpen(false);
//             } else {
//                 setError(`Failed to update payment status. Server responded with status: ${response.status}`);
//             }
...
//                                                 <motion.button
//                                                     onClick={() => handleEditPayment(payment)}
//                                                     className="bg-white gap-2 cursor-pointer rounded-md px-4 py-2 font-medium text-error focus:outline-none flex items-center"
//                                                 >
//                                                     <Edit size={18} />
//                                                     Edit
//                                                 </motion.button>
...
//                             <button
//                                 onClick={() => setShowFilterModal(true)}
//                                 className="flex items-center cursor-pointer gap-2 bg-primary text-secondary font-medium text-lg px-10 py-3 rounded-lg hover:bg-primary-hover transition-colors"
//                             >
//                                 <Filter size={18} />
//                                 Filters
//                             </button>
...
//                             <div className='mb-6'>
//                                 <h2 className="text-xl font-semibold text-main">Edit Payments </h2>
//                             </div>
...
//     const handleStatusDropdownChange = async (status) => {
//         if (!selectedPaymentForEdit) return;
//         setStatusUpdateLoading(prevState => ({ ...prevState, [selectedPaymentForEdit._id]: true }));
//         setError(null);
//         setSuccessMessage(null);
...
//                 const updatedPayments = payments.map(payment =>
//                     payment._id === selectedPaymentForEdit._id ? { ...payment, status: status } : payment
//                 );
//                 setPayments(updatedPayments);
//                 setFilteredPayments(updatedPayments); // Keep filtered payments in sync
...
//             console.error("Error updating payment status:", err);
//         } finally {
//             setStatusUpdateLoading(prevState => ({ ...prevState, [selectedPaymentForEdit._id]: false }));
//         }
//     };


//     const handleSaveEdit = async () => {
//         // No longer used for status update, can be used for other edits in future if needed
//         setIsEditModalOpen(false); // Just close modal for now as status update is immediate
//     };
...
//                                     label="Status"
//                                     value={editFormData.status || null}
//                                     onChange={handleStatusDropdownChange} // Now handleStatusDropdownChange does the update
//                                     options={statusOptions.filter(opt => opt !== 'all')}
//                                 />
//                             </div>
