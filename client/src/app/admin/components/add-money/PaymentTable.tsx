...
//                                 <td className="px-6 py-3 whitespace-nowrap"><Skeleton className="h-4 w-16" /></td>
//                                 <td className="px-6 py-3 whitespace-nowrap"><Skeleton className="h-4 w-24" /></td>
//                                 <td className="px-6 py-3 whitespace-nowrap"><Skeleton className="h-7 w-28" /></td>
//                                 <td className="px-6 py-3 whitespace-nowrap text-sm font-medium"><Skeleton className="h-8 w-24" /></td>
//                             </tr>
//                         ))}
//                     </tbody>
//                 </table>
