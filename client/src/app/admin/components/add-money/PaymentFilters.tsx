                        ...
                        <div className="p-6 space-y-6 flex-grow overflow-y-auto scrollbar-hide"> {/* Apply scrollable content styles */}
                            ...
                            <div className="mb-4">
                                ...
                                <input
                                    ...
                                    placeholder="Filter by Payment ID"
                                    className="block h-16 w-full rounded-md py-3 px-4 text-neutral-900 hover:shadow-darkcolor hover:dark:shadow-whitecolor transition-shadow ease-in-out duration-300 dark:text-white placeholder:text-gray-500 dark:placeholder:text-white focus:outline-none font-medium"
                                />
                            </div>
                            {/* Amount Filter */}
                            <div className="mb-4">
