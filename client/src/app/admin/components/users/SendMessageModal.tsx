      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            animate="animate"
            exit="exit"
            className="bg-background sm:rounded-3xl sm:rounded-t-3xl w-full sm:max-w-lg relative flex flex-col overflow-hidden sm:h-auto h-screen" // Added sm:h-auto h-screen
            onClick={(e) => e.stopPropagation()} // Prevent click propagation to backdrop if using onClick on parent
          >
            {/* Header */}
            <div className="p-4 sm:p-6 flex items-center justify-between flex-shrink-0 border-b font-medium">
