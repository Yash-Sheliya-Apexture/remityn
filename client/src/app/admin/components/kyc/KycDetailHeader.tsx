    ...
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-5 gap-4">
      ...
      <div className="Heding">
        <div className="flex items-center text-sm mb-2 flex-wrap">
          ...
          <ChevronRight className="size-4 mx-1 flex-shrink-0 text-mainheadingWhite" /> {/* Adjusted color */}

          {/* Breadcrumb Item 2: KYC Management */}
          <Link href="/admin/kyc-management" className="text-subheadingWhite hover:text-primary">
            KYC Management
          </Link>
          ...
          <span
            className="text-subheadingWhite truncate" // Adjusted color
