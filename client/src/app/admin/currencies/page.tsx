...
//       <div className="overflow-x-auto mt-10 bg-white shadow-md rounded-lg border w-fit mx-auto">
...
//                      placeholder="e.g., USD" className="w-full rounded-lg border border-gray-300 px-4 py-3 hover:shadow-darkcolor focus:outline-none transition-shadow ease-in-out duration-300 sm:text-sm"/>
...
//       {/* Action Bar */}
//       <div className="flex justify-end sm:flex-row w-full flex-col md:items-center mb-6 gap-4">
//         <button
//           onClick={() => {
//             setIsCreateModalOpen(true);
//           }} // Clear error on open
//           className="bg-primary text-neutral-900 hover:bg-primaryhover text-nowrap font-medium rounded-full px-6 py-3 h-12.5 text-center flex items-center gap-1 cursor-pointer transition-all duration-75 ease-linear"
//         >
...
//             type="text"
//             placeholder="Search currencies..."
//             className="rounded-full pl-10 pr-3 h-12.5 border w-1/2 md:w-full transition-shadow ease-in-out duration-300 border-neutral-900 hover:shadow-darkcolor dark:hover:shadow-whitecolor dark:border-white focus:outline-none focus:ring-0 dark:focus:shadow-whitecolor focus:shadow-darkcolor placeholder:text-neutral-900 dark:placeholder:text-white"
//             value={searchTerm}
//             onChange={(e) => setSearchTerm(e.target.value)}
//           />
...
//                       onClick={handleUpdateCurrency}
//                       disabled={isSubmitting}
//                       className="flex-1 flex justify-center cursor-pointer items-center gap-1.5 bg-blue-600/20 h-12.5 text-blue-600 font-medium px-6 py-3 rounded-full transition duration-200 focus:outline-none"
//                     >
//                       {isSubmitting ? (
//                         <Loader2 size={20} className="animate-spin" />
//                       ) : (
...
//                     <button
//                       onClick={cancelEditing}
//                       className="flex-1 flex justify-center cursor-pointer items-center gap-1.5 bg-red-600/20 h-12.5 text-red-600 font-medium px-6 py-3 rounded-full transition duration-200 focus:outline-none"
//                     >
//                       <IoMdCloseCircle size={20} /> Cancel
//                     </button>
//                   </div>
...
//                   <button
//                     onClick={() => setIsCreateModalOpen(false)}
//                     className="bg-neutral-900 capitalize flex justify-center items-center gap-2 text-primary dark:bg-primarybox dark:hover:bg-secondarybox dark:text-primary font-medium rounded-full px-6 py-3 h-12.5 text-center border border-gray w-full cursor-pointer transition-all duration-75 ease-linear"
//                   >
//                     Cancel
//                   </button>
//                 </div>
    ...
    <div className="min-h-screen p-4 bg-gray-50 dark:bg-background dark:text-white">
      ...
      <div className="flex justify-end flex-col lg:flex-row w-full  md:items-center mb-6 space-y-3 lg:space-y-0 gap-4">
        ...
        <button
          ...
          className="bg-primary text-neutral-900 dark:text-white flex hover:bg-primaryhover text-nowrap font-medium rounded-full text-center lg:px-6 p-2 lg:py-3 lg:h-12.5  items-center gap-1 cursor-pointer transition-all duration-75 ease-linear"
        >
          <IoMdAdd  
            className="size-8"
